...
//  const  numberOfDroids = prompt ('Please enter a number of droids!') // всегда вернется строка ..."5"
...
// do {input = +prompt('Input a number') //плюс "заставляет" javascript понять, что введённое значение должно было быть интерпретировано как число
//     total+= input;
// }while (input);
